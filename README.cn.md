...
- **最新版本**: `2.21.0` (2026-08-17)
- **最近提交**: 2026-08-17

## 流行度

- **Star**: 2,207 · **Fork**: 880 · **开放 issue**: 1,950 · **贡献者**: 784

## 累计统计

- **发布数**: 37 · **已合并 PR**: 928 · **开放 PR**: 226 · **已关闭 issue**: 1518 · **开放 issue**: 432 · **提交数**: 7275

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 1 | 0 | 49 | 0 | 8 | 3 |
| last60d | 2026-07-13 | 1 | 5 | 74 | 0 | 13 | 11 |
| 90d | 2026-06-13 | 1 | 53 | 81 | 2 | 13 | 77 |
| last180d | 2026-03-15 | 2 | 87 | 107 | 18 | 18 | 127 |
| 360d | 2025-09-16 | 2 | 121 | 124 | 37 | 26 | 190 |
| last720d | 2024-09-21 | 5 | 168 | 170 | 78 | 58 | 383 |
...
pygments 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `pygments` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/pygments.yml>（或索引实际使用的路径）
